...
library PlanetMobius {
    ...
    // ========= Views =========
    function pmTimes(PlanetMobius.State storage state)
        internal
        view
        returns (uint256)
    {
    ...
    function startHeight(PlanetMobius.State storage state)
        internal
        view
        returns (uint256)
    {
    ...
    function pmBalance(PlanetMobius.State storage state, address usr)
        internal
        view
        returns (uint256)
    {
    ...
    function airdropLeft(PlanetMobius.State storage state)
        internal
        view
        returns (uint256)
    {
    ...
    // ========= Functions =========
    function airdrop(PlanetMobius.State storage state, address to)
        internal
        returns (uint256)
    {
    ...
    function init(
        PlanetMobius.State storage state,
        address a1,
        address a2,
        uint256 peroid,
        uint256 round
